...
describe('Owner system', () => {
    ...
    describe('Dispatcher ownerOnly guard', () => {
        function build() {
            ...
            const rpg = new RpgService(new PlayerRepository(db));
        ...
        async function dispatch({ dispatcher }, opts) {
            const replies = [];
