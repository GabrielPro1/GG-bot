...
export function cleanupTempDir(dbPath) {
    try {
...
export function insertTestIdentity(db, userId) {
    db.prepare(`INSERT INTO identities (user_id, lid_jid, pn_jid, username) VALUES (?, null, null, null)`).run(userId);
}
