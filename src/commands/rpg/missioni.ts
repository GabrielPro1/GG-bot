import type { ClaimMissionResult } from '../../services/rpg/types.js';
import type { Command } from '../types.js';

const SIGNATURE = '╰━━━━━━━━ ✨ GG BOT ✨ ━━━━━━━━╯';

function renderProgressBar(progress: number, target: number): string {
  const segments = 5;
...
function renderMissionsBox(missions: ReturnType<import('../../services/rpg/types.js').RpgServiceView['getDailyMissions']>): string {
  return [
    '╭━━━━━━━━━━━━━━━━━━━━━━━━━━╮',
    '┃    📜 MISSIONI RPG    ┃',
    '╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯',
    ...
    ...missions.flatMap((mission, index) =>
      index === 0 ? renderMission(mission) : ['', ...renderMission(mission)],
    ),
    '',
...
function renderClaimResult(result: ClaimMissionResult): string {
  if (result.ok) {
    return [
      '╭━━━━━━━━━━━━━━━━━━━━━━━━━━╮',
      '┃     🎉 RISCATTO     ┃',
